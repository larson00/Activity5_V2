public class VehicleChassis implements Chassis {
  ...
  // A public method named getChassisType that doesn't have a formal parameter and that
  // returns an instance of the interface Chassis (hint that would be a copy of this class).
  public Chassis getChassisType() {
    return this;
  }

  // A public method setChassisType that takes a String parameter vehicleChassis
  // and that returns a void. It should set the instance variable chassisName.
